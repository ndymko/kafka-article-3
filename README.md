...
Пример из статьи ["Kafka для начинающих: гарантии доставки на практике и настройка идемпотентности"](https://habr.com/ru/articles/961048/) на Хабре
...
```bash
git clone https://github.com/Mitohondriyaa/kafka-article-3
cd kafka-article-3
```
